 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */class P{constructor(t){this.G=t}disconnect(){this.G=void 0}reconnect(t){this.G=t}deref(){return this.G}}class j{constructor(){this.Y=void 0,this.Z=void 0}get(){return this.Y}pause(){this.Y??(this.Y=new Promise((t=>this.Z=t)))}resume(){var t;null==(t=this.Z)||t.call(this),this.Y=this.Z=void 0}}
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const A=t=>{return!(r=t,null===r||"object"!=typeof r&&"function"!=typeof r||"function"!=typeof t.then);var r},T=1073741823;const O=c(class extends R{constructor(){super(...arguments),this._$Cwt=T,this._$Cbt=[],this._$CK=new P(this),this._$CX=new j}render(...t){return t.find((t=>!A(t)))??o}update(t,r){const e=this._$Cbt;let a=e.length;this._$Cbt=r;const i=this._$CK,n=this._$CX;this.isConnected||this.disconnected();for(let o=0;o<r.length&&!(o>this._$Cwt);o++){const t=r[o];if(!A(t))return this._$Cwt=o,t;o<a&&t===e[o]||(this._$Cwt=T,a=0,Promise.resolve(t).then((async r=>{for(;n.get();)await n.get();const e=i.deref();if(void 0!==e){const a=e._$Cbt.indexOf(t);a>-1&&a<e._$Cwt&&(e._$Cwt=a,e.setValue(r))}})))}return o}disconnected(){this._$CK.disconnect(),this._$CX.pause()}reconnected(){this._$CK.reconnect(this),this._$CX.resume()}});const L=new class{constructor(){this.cache=new Map}set(t,r){this.cache.set(t,r)}get(t){return this.cache.get(t)}has(t){return this.cache.has(t)}delete(t){this.cache.delete(t)}clear(){this.cache.clear()}},k=t`
  :host {
    display: flex;
